...
class filterex(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "filterex")
        ...
        self._frequency_range = qtgui.Range(-samp_rate/2, samp_rate/2, 1, 50, 200)
...
def main(top_block_cls=filterex, options=None):
