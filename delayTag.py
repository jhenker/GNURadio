...
class delayTag(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "delaytags", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("delaytags")
        ...
        self.settings = Qt.QSettings("GNU Radio", "delayTag")
...
def main(top_block_cls=delayTag, options=None):
