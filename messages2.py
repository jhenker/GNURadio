...
import messages2_epy_block_0 as epy_block_0  # embedded python block
import messages2_epy_block_1 as epy_block_1  # embedded python block
import sip



class messages2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Messages2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Messages2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "messages2")
...
def main(top_block_cls=messages2, options=None):
