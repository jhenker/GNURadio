...
class NBFMrcv(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "NarrowBand", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "NBFMrcv")
        ...
        self._volume_range = qtgui.Range(0, 1, 0.05, 0.05, 200)
        ...
        self._sq_lvl_range = qtgui.Range(-100, 0, 1, -50, 200)
        ...
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://123.0.0.1:49203', 100, False, (-1), '', False)
...
def main(top_block_cls=NBFMrcv, options=None):
