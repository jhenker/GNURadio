...
# Title: Sample Rate/ Interpolation
...
class samplerate(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Sample Rate/ Interpolation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sample Rate/ Interpolation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "samplerate")
...
def main(top_block_cls=samplerate, options=None):
